...
WORDLIST_FILENAME = "/home/sjonbak23/code/personal-repo/mitPython/6001x game/ProblemSet4/words.txt"
...
def getWordScore(word, n):
    ...
    for l in word:
        score_list.append(SCRABBLE_LETTER_VALUES[l]*len(word))
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    if ending1 != 1:            
        print 'Game is over, you scored ', total_score, ' points.'
...
if __name__ == '__main__':
    wordList = loadWords()
    #playGame(wordList)
    playHand({'h': 1, 'e': 2, 't': 2}, wordList, HAND_SIZE)
